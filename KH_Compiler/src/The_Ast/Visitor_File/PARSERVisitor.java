...
public interface PARSERVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link PARSER#printSTRING}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrintSTRING(PARSER.PrintSTRINGContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link PARSER#operant}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOperant(PARSER.OperantContext ctx);
	/**
